function varargout = SingleShapeLandmarkSCAPE(varargin)
% SINGLESHAPELANDMARKSCAPE MATLAB code for SingleShapeLandmarkSCAPE.fig
%      SINGLESHAPELANDMARKSCAPE, by itself, creates a new SINGLESHAPELANDMARKSCAPE or raises the existing
%      singleton*.
%
%      H = SINGLESHAPELANDMARKSCAPE returns the handle to a new SINGLESHAPELANDMARKSCAPE or the handle to
%      the existing singleton*.
%
%      SINGLESHAPELANDMARKSCAPE('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SINGLESHAPELANDMARKSCAPE.M with the given input arguments.
%
%      SINGLESHAPELANDMARKSCAPE('Property','Value',...) creates a new SINGLESHAPELANDMARKSCAPE or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before SingleShapeLandmarkSCAPE_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to SingleShapeLandmarkSCAPE_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help SingleShapeLandmarkSCAPE
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @SingleShapeLandmarkSCAPE_OpeningFcn, ...
                   'gui_OutputFcn',  @SingleShapeLandmarkSCAPE_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before SingleShapeLandmarkSCAPE is made visible.
function SingleShapeLandmarkSCAPE_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to SingleShapeLandmarkSCAPE (see VARARGIN)

% Choose default command line output for SingleShapeLandmarkSCAPE
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes SingleShapeLandmarkSCAPE wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = SingleShapeLandmarkSCAPE_OutputFcn(hObject, eventdata, handles) 
